                                            ...
                                            return (
                                                <div className="action-container">
                                                    ...
                                                    <Modal isOpen={this.state.modal} className={this.props.className}>
                                                        <ModalHeader toggle={this.toggleButtonDelete}>Delete
                                                            product</ModalHeader>
                                                        <ModalBody>
                                                        ...
                                                        <ModalFooter>
                                                            <Button color="primary"
                                                                    onClick={(e) => this.onHandleDelete(e, this.state.idProduct)}>Delete</Button>{' '}
                                                            <Button color="secondary"
                                                                    onClick={() => this.toggleButtonDelete('')}>Cancel</Button>
                                                        </ModalFooter>
                                                    </Modal>
                                                </div>
                                            );
                                ...
                                <div>
                                    <Row className="d-flex justify-content-center pt-4 pb-4">
                                        <Col md={11} lg={11} xs={11}>
                                            <Form receiveData={this.state.pushData} addNewMode={addNewMode}
