...
class EmailEditForm extends Component {
    ...
    componentDidMount() {
        console.log('this.props.receiveData',this.props.receiveData);
        if(this.props.receiveData){
            const {receiveData: {notifyDetail:{_id,title , content, statusSent}}} = this.props;
            ...
            <Card>
                <CardBody>
                    <div className='card_title_notification'>
                        <h5 className='bold-text'>Edit Email Form</h5>
                    </div>
                    <div className="addNotification-form-container">
                        <form className='material-form'>
                            ...
                            <input type="email" name="Email" required className="form-control"
                                   label={`Email`} onBlur={this.handleInputValidation}
                                   value={title ? title : ''}
